...
contract Battle is CardHelper {
    ...
    function _initBattle(uint _cardId) internal returns (uint) {
        ...
        BattleData memory battle = BattleData(battles.length + 1, msg.sender, address(0), _cardId, 0, msg.value, 0, new uint[](0), new uint[](0), address(0), address(0), false, "waitP2");
